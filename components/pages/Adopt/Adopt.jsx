      ...
      <div className="h-screen">
        ...
        <div className="flex mb-10">
          <a
            className={classNames(
              'w-1/2 border-b-2 pb-2 text-center font-medium text-black/70 hover:cursor-pointer',
              animalType === 'dog'
                ? 'border-[#DADADA]'
                : 'border-[#DADADA/60] text-black/50 font-normal'
            )}
            id="dog"
        ...
        <div className="pl-4 space-y-10">
          <p className="text-black/50 text-center">
            Help us find a new home to <span className="text-[#00A6EB]">{0}</span>{' '}
            {`${animalType.charAt(0).toUpperCase() + animalType.substring(1)}'s`}
          </p>
